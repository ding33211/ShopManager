package com.soubu.goldensteward.support.widget.optionspickerview;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                contentText = TextUtils.ellipsize(contentText, paintCenterText, width, TextUtils.TruncateAt.END).toString();
