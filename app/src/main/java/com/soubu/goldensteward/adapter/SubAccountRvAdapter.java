...
import com.soubu.goldensteward.module.SubAccountModule;
...
public class SubAccountRvAdapter extends BaseRecyclerViewAdapter<SubAccountModule> implements RecyclerViewFastScroller.BubbleTextGetter, Filterable {
...
//        mParams.addAll(helper.getStaffDao().loadAll());
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            if (type == SubAccountModule.TYPE_REVIEW) {
